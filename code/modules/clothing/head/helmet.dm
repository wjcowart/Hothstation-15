...
/obj/item/clothing/head/helmet_old
	name = "old helmet"
	desc = "Old Security gear. Protects the head from impacts."
...
/obj/item/clothing/head/helmet/space/helmet_old
	name = "old space helmet"
	icon_state = "spacehelmet_old"
	item_state = "spaceo"
	desc = "It's just a cardboard box painted white..."
	flags_inv = HIDEFACE
...
/obj/item/clothing/head/helmet/swat_old
	name = "\improper SWAT helmet"
	desc = "It looks just like the security helmet, only a bit more black."
	icon_state = "swat_old"
	flags = FPRINT
	item_state = "rioto"
	armor = list(melee = 80, bullet = 60, laser = 50,energy = 25, bomb = 50, bio = 10, rad = 0)
